...
def compare_list(graph_list, h=1, node_label=True):
...
def compare(g_1, g_2, h=1, node_label=True):
    ...
    """
    gl = [g_1, g_2]
    return compare_list(gl, h, node_label)[0, 1]
